...
import { descargaPruebaAdmin, getMarcasAdmin, openCloseModalMarcas } from '../../../actions/marcas';
import { ExcelCumplimiento } from '../widgets/reports/ExcelCumplimiento';
...
export const InventarioMarcasScreen = () => {
    ...
    const handleDescarga = () => {
        dispatch(descargaPruebaAdmin(true));
    }
            ...
            <div className="col-md-12">
                <div className="card">
                    <div className="card-header d-flex justify-content-between">
                        ...
                        <button onClick={handleDescarga} type="button" className="btn btn-info btn-circle btn-lg" title='Agregar nuevo usuario'>
